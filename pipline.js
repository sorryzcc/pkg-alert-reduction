...
// 定义文件路径
const Configurationspath = '/data/landun/workspace/Configurations.xlsx';
...
// 直接获取所有责任人的列表，包括重复项
const allResponsibles = ConfigurationsData.map(item => item['责任人']).filter(Boolean).join(','); // 过滤掉可能存在的空值
